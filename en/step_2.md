...
Open the [starter project]([https://editor.raspberrypi.org/hello-world-starter](https://editor.raspberrypi.org/projects/hello-world-starter)){:target="_blank"}. The Code Editor will open in another browser tab.
